    ...
    return (
        <>
            ...
            <select
                ...
                value={sortBy}
                id="underline_select"
                className="block py-2.5 px-3 w-full text-sm text-gray-500 font-medium bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"
            >
